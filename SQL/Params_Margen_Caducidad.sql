...
--SELECT * FROM Tbl_ParametroAudit WHERE Par_Codigo LIKE 'Reserva/MargenCaducidad'
--SELECT * FROM Tbl_ParametroAudit WHERE Par_Codigo LIKE 'Reserva/HoraLimiteCaducidad'