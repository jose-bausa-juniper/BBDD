...
WHERE 1 = 1
    ...
    --AND ti.Ti_idGrupo IN (10)
    --AND ti.TI_id NOT IN (35)
    AND i.I_estat <> 'C'
	AND (
		us.U_nom like '%Jose Baus�%'
		OR us.U_nom like '%Ahinoam Perez Ruiz%'
		OR us.U_nom like '%Iv�n Mill�n%'
		OR us.U_nom like '%Eduardo Feij�o Pons%'
		OR us.U_nom like '%Miquel Gay�%'
		OR us.U_nom like '%Daniel Suau%'
		)
...
ORDER BY 
i.FecCre,U_nom, Tipo, Estado ASC